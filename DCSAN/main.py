...
from model.lexicon_augment_ner import GazLSTM as SeqModel
...
def data_initialization(data, gaz_file, train_file, dev_file, test_file,count=False):
...
def train(data, save_model_dir, seg=True):
    ...
    # m = {
    #     'adam': Adam(model.parameters(), lr=0.0005),
    #     'sgd': SGD(model.parameters(), lr=0.0005, momentum=0.9),
    #     'adamw': AdamW(model.parameters(), lr=0.0005)
    # }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedset', help='Dir of saved data setting', default="data/save.dadset")
    ...
    parser.add_argument('--num_iter', default=40, type=int)
    ...
    char_emb =  "cpt/gigaword_chn.all.a2b.uni.ite50.vec"
    # bichar_emb = "cpt/gigaword_chn.all.a2b.bi.ite50.vec"
    gaz_file = "cpt/Tencent_AILab_ChineseEmbedding.txt
    sys.stdout.flush()
